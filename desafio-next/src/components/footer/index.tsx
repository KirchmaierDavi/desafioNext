...
export function Footer() {
  return (
    <Flex as="footer" py={7} px={11} h={{base: "fit-content",md: "156px"}} bg={"#003554"} flexDirection={{base: "row", md: "column"}} align={{base: "center", md: "unset"}} flexWrap={"wrap"}>
      <Stack as="section" justify={{base: "center", md:"unset"}}>
        <Image
          width={{base: 36, md: 92}}
          height={{base: 36, md: 92}}
          src='./'
          alt={"Blueskins logo"}
        />
      </Stack>
      <Stack as="section">
        <Text textTransform={"uppercase"} fontFamily={"Wallpoet"} fontSize={{base: 16, md:40}} textAlign={"center"}>blueskins</Text>
        <HStack as={"section"} spacing={{base: 5, md: 76}}>
      ...
      <Stack as="section" flexWrap={"wrap"}>
        <Box h={{base: "auto",md: 92}} w ={{base: "fit-content", md: "1026px"}} bg={"#051923"} borderRadius={"5px"}>
