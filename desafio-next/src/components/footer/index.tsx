import { HStack, Stack, Text, Button, ButtonGroup, Center, Box } from "@chakra-ui/react";
...
export function Footer() {
  return (
    <HStack as="footer" py={7} px={11} w={"100%"} h={"156px"} bg={"#003554"} spacing={"108px"}>
      ...
      <Stack as="section">
        <Box h={92} w ={"1036px"} bg={"#051923"} borderRadius={"5px"}>
